...
import {
  ...
  Wheat, Truck, CheckCircle2, Clock, BarChart3, Sprout, Menu, X,
  ...
  return (
    <div className="dsh-content">
      <div className="dsh-page-header">
        ...
        <button className="dsh-ghost-btn dsh-ghost-btn--border">
              ...
              {filtered.map(o => (
                <>
                  <tr key={o.id} style={{ cursor:'pointer' }} onClick={() => setExpanded(expanded === o.id ? null : o.id)}>
                    <td style={{ width: 32 }}>
                      <ChevronDown size={14} style={{ color:'#8a9a84', transform: expanded === o.id ? 'rotate(180deg)' : 'none', transition:'0.2s' }} />
                    </td>
                  ...
                  {expanded === o.id && (
                    <tr key={`${o.id}-detail`}>
                      <td colSpan={8} style={{ background:'#f8faf7', padding: '16px 24px', borderBottom: '1px solid #ece9e3' }}>
                        <div style={{ display:'flex', gap:32, alignItems:'flex-start', flexWrap:'wrap' }}>
                          <div style={{ flex:1 }}>
                            <p style={{ fontSize:12, fontWeight:700, color:'#8a9a84', textTransform:'uppercase', letterSpacing:'0.5px', margin:'0 0 10px' }}>
                              Order Tracking
                            </p>
                          ...
                          <div style={{ minWidth:160 }}>
                            ...
                            <div style={{ fontSize:13, display:'flex', flexDirection:'column', gap:6 }}>
                              <div><span style={{ color:'#8a9a84' }}>Unit Price:</span> <strong>{o.unitPrice}</strong></div>
                              <div><span style={{ color:'#8a9a84' }}>Quantity:</span> <strong>{o.qty}</strong></div>
                              <div><span style={{ color:'#8a9a84' }}>Total:</span> <strong style={{ color:'#166534' }}>{o.amount}</strong></div>
                            </div>
                          </div>
                          ...
                          {role === 'farmer' && o.status === 'processing' && (
    ...
    <div className="dsh-content">
      ...
      <div className="dsh-page-header">
        ...
        <div style={{ display:'flex', gap:10 }}>
          <button className="dsh-cta-btn"><Plus size={15}/> Place Order</button>
          <button className="dsh-ghost-btn dsh-ghost-btn--border" style={{ background:'#fff' }}>
        ...
        <div className="dsh-donz-left">
          ...
          <div className="dsh-card">
            <div className="dsh-card-header">
              ...
              <button className="dsh-cta-btn" style={{ fontSize:12, padding:'7px 12px' }}>
                <Plus size={13}/> Add Farmer
              </button>
            </div>
        ...
        <div className="dsh-donz-right">
          ...
          <div className="dsh-card">
            <div className="dsh-card-header">
              ...
              <button className="dsh-ghost-btn" style={{ fontSize:12 }}>
                <Plus size={13}/> New
              </button>
            </div>
            <div className="dsh-reminder-card">
              ...
              <button className="dsh-cta-btn" style={{ fontSize:12, padding:'8px 14px', whiteSpace:'nowrap', alignSelf:'center' }}>
                View Listing
              </button>
            </div>
          </div>
  ...
  return (
    <div className="dsh-content">
      <div className="dsh-page-header">
        ...
        <div className="dsh-search-wrap">
          <Search size={14} className="dsh-search-icon"/>
          <input className="dsh-search-input" placeholder="Search produce or farmer..." value={search} onChange={e => setSearch(e.target.value)}/>
        </div>
      </div>
...
export default function DashboardPage() {
  ...
  return (
    <div className="dsh-root">
      ...
      {/* ── WHITE SIDEBAR ── */}
      <aside className={`dsh-sidebar ${sidebarOpen ? 'dsh-sidebar--open' : ''}`}>
        <div className="dsh-sidebar-logo">
          ...
          <button className="dsh-sidebar-close" onClick={() => setSidebarOpen(false)}><X size={18}/></button>
        </div>
      ...
      <main className="dsh-main">
        <header className="dsh-topbar">
          <button className="dsh-menu-btn" onClick={() => setSidebarOpen(true)}><Menu size={20}/></button>
          ...
          <div className="dsh-topbar-right">
            <div className="dsh-topbar-search">
              ...
              <input placeholder="Search crops, orders, buyers..." className="dsh-topbar-search-input" />
            </div>

            <button className="dsh-notif-btn" aria-label="Messages">
              <MessageSquare size={18}/>
            </button>

            <button className="dsh-notif-btn" aria-label="Notifications">
              <Bell size={18}/><span className="dsh-notif-dot"/>
            </button>

            <div className="dsh-topbar-user" onClick={() => handleNav('profile')} title="My Profile">
              <div className="dsh-topbar-avatar">{user.fullName.charAt(0).toUpperCase()}</div>
              <span className="dsh-topbar-name">{user.fullName.split(' ')[0]}</span>
            </div>
          </div>
        </header>
